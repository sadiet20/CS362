...
Author: Sadie Thomas
Date: 4/25/21
Description: determines if a year is a leap year (no error handling)
Inputs: a year (number)
Outputs: yes or no
Running instructions: My program runs on python3, so if you are using the terminal you can run the command $python3 leap_no_eh.py
'''
